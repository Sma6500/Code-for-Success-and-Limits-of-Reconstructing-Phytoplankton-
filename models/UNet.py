...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov  6 15:11:24 2023
...
class UNet(nn.Module):
    ...
    def __init__(self, in_channels=8, out_channels=3, depth=5, start_filts=64, 
                 up_mode='bilinear', merge_mode='concat', activation='ReLU',chl=False):
        ...
        for i in range(depth-1):
            ins = outs
            outs = ins // 2
            up_conv = UpConv(ins, outs, up_mode=up_mode, merge_mode=merge_mode, activation=self.activation)
...
if __name__ == "__main__":
    ...
    model = UNet(depth=5, in_channels=7, out_channels=3, merge_mode='concat', activation='ReLU',chl=4)
    ...
    # output_names = ['yhat']
    a=torch.Tensor(np.random.random(((1,7,360,100)))).to(device='cuda')
