...
train_config = {
    ...
    'checkpoints_path': '/home/luther/Documents/result/chl_only_monthly/variables/', 
    'verbose': 0.,
    'checkpoint':None, #save the weights every x epochs
    'name':'SmaAt_chlm_avw_only_variables_sst_sss_ssh_solar_currents',
