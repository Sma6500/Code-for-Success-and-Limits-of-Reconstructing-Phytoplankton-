...
train_config = {
    ...
    'comment':'light smaat avec une validation plus petite et plus de training'
}
...
criterion_config = {
    'MSE_psc' : 4., # eventual features and weights of losses (put None instead of 0 if you don't want the loss to be compute)
    'MSE_chl':1.,
    'Under_chl':0.,
    'KL_div':0.,
    'quantile_loss':3,
...
scheduler_config = {
    ...
    'factor': 0.8, # when loss has stagnated for too long, new_lr = factor*lr
