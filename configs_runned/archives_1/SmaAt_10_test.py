...
train_config = {
    ...
    'comment':'SmaAt test avec la quantile loss update, un clip pour les hautes val de chl, le test au milieu et SiLU '
}
...
criterion_config = {
    'MSE_psc' : 2., # eventual features and weights of losses (put None instead of 0 if you don't want the loss to be compute)
    'MSE_chl':1.,
    'Under_chl':0.,
    'KL_div':0.,
    'quantile_loss':1.,
