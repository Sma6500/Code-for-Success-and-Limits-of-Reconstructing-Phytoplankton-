...
dataloader_config={'dataset_path_inputs':path+"physics/new_processed_physics_1998_2020_8d_100_lat50.npy",
...
train_config = {
    ...
    'name':'SmaAt_7_test_1',
    'patience_early_stopping':150, #needs to be >>> patience of lr scheduler
    ...
    'comment':'SmaAt test avec bcp de poids sur psc loss et un lr de départ très faible et année de test différentes'
}
...
criterion_config = {
    'MSE_psc' : 10000., # eventual features and weights of losses (put None instead of 0 if you don't want the loss to be compute)
    'MSE_chl':1.,
    'Under_chl':0.,
    'KL_div':0.,
    'quantile_loss':4.,
...
scheduler_config = {
    ...
    'factor': 0.9, # when loss has stagnated for too long, new_lr = factor*lr
