...
train_config = {
    ...
    'name':'SmaAt_DBNet_0',
    'patience_early_stopping':250, #needs to be >>> patience of lr scheduler
    ...
    'comment':'Basic training for SmaAt_DBNet with normalizing chl and with one input timestep'
}
