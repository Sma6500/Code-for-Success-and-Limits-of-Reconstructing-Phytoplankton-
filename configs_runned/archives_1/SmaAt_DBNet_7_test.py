...
train_config = {
    ...
    'checkpoints_path': '/datatmp/home/lollier/results/', 
    'verbose': 0.,
    'checkpoint':None, #save the weights every x epochs
    'name':'SmaAt_DBNet_7_test',
    'patience_early_stopping':200, #needs to be >>> patience of lr scheduler
    ...
    'comment':'SmaAt-DBNET training 1 timestep for article sans under chl'
}
...
criterion_config = {
    'MSE_psc' : 0.1, # eventual features and weights of losses (put None instead of 0 if you don't want the loss to be compute)
    'MSE_chl':1.,
    'Under_chl':0.
}
...
scheduler_config = {
    ...
    'factor': 0.70, # when loss has stagnated for too long, new_lr = factor*lr
