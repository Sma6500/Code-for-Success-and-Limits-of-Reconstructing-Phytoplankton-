...
dataloader_config={'dataset_path_inputs':path+"physics/physics_completion/processed_1998_2023_reanalysis_100km_8d_seaice_32.npy",
                   'dataset_path_psc':path+"completion/occci_cmems/p_psc_occci_cmems_TGDM_1998_2023_8d_100.npy",
                   'dataset_path_chl':path+"completion/occci_cmems/p_chl_occci_cmems_TGDM_1998_2023_8d_100.npy",
                   'transform':None,
                   'batch_size': 16,
                   'norm_chl':True,
                   'norm_mode':'standard',
...
train_config = {
    ...
    'name':'SmaAt_occci_completion_test',
    ...
    'comment':'SMaat pour compléter les données occci cmems avec psc'
}
