...
train_config = {
    ...
    'checkpoints_path': '/home/luther/Documents/result/chl_occci_only_monthly/variables/', 
    'verbose': 0.,
    'checkpoint':None, #save the weights every x epochs
    'name':'SmaAt_chlm_occci_only_variables_sst_sss_ssh_solar',
