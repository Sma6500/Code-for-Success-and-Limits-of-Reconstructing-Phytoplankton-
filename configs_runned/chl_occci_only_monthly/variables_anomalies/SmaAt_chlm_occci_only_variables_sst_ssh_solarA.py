...
dataloader_config={'dataset_path_inputs':path+"physics/physics_completion/processed_1998_2023_reanalysis_100km_monthly_lat50_seaice.nc",
                   ...
                   'dataset_path_chl':path+"chl/chl_occci_1998_2023_100km_monthly_lat50.npy",
                   ...
                   'stations_coord':{'SWAtl':(-55,-43),# stations withdrawed of the dataset for control
                                     ...
                                     'SIO':(60,-32),
                                     'SCTR':(80,-3)},
                   'variables_physiques':[1,3,4],
                   'phy_anomalies':[1,3,4], #[0,1,2,3...] list of which physical fields anomalies should be added
                   'chl_anomalies':False, 
                   } 
                   #weekly
...
train_config = {
    ...
    'checkpoints_path': '/home/luther/Documents/result/chl_occci_only_monthly/variables_anomalies/', 
    'verbose': 0.,
    'checkpoint':None, #save the weights every x epochs
    'name':'SmaAt_chlm_occci_only_variables_sst_ssh_solarA',
...
model_config = {
    ...
    'freeze_key':'0',
    'kernels_per_layer':1,
    'n_classes':1, #à adapter en fonction d'une éventuelle pinball loss
