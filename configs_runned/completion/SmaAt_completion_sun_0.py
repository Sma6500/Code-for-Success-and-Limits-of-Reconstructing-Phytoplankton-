...
dataloader_config={'dataset_path_inputs':path+"physics/physics_completion/processed_1998_2023_reanalysis_100km_daily_seaice.nc",
                   ...
                   'dataset_path_chl_psc':path+"completion/sun2023/Sun2023_1998-2023_glob_100_1d_prop.nc",
...
train_config = {
    ...
    'name':'SmaAt_completion_sun2023_0_test',
...
model_config = {
    ...
    'merge_mode':'concat',
    'activation':'SiLU',
    'weight_load':'/home/luther/Documents/result/completion/SmaAt_completion_sun2023_0/SmaAt_completion_sun2023_0best_valid_loss.pt', # None
    'freeze_key':'0',
    'kernels_per_layer':2,
