...
dataloader_config={'dataset_path_inputs':path+"physics/physics_completion/processed_1998_2023_reanalysis_100km_daily_seaice.nc",
                   ...
                   'dataset_path_chl_psc':path+"completion/CMEMS_Globcolour/chl_psc_pcorrected_avw_cmems_1d_glob_100km_1998_2023.nc",
...
train_config = {
    ...
    'name':'SmaAt_completion_avw_cmems_wth_phy',
    ...
    'comment':'SMaat completion MSE classique wth phy'
}
