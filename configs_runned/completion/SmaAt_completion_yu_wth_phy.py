...
train_config = {
    ...
    'checkpoints_path': '/home/luther/Documents/result/completion/completion_wth_phy/', 
    'verbose': 0.,
    'checkpoint':None, #save the weights every x epochs
    'name':'SmaAt_completion_yu2024_wth_phy',
    ...
    'comment':'SMaat completion MSE classique, attention il manque les 3 derniers mois de 2023 + wth phy'
}
