...
train_config = {
    ...
    'checkpoints_path': '/home/luther/Documents/result/avw_psc_chl_monthly/chl_anom/', 
    'verbose': 0.,
    'checkpoint':None, #save the weights every x epochs
    'name':'SmaAt_chlm_avw_variables_all_chl_anom_psc',
    ...
    'comment':'test en prédisant également les anomalies de chl'
}
...
model_config = {
    ...
    'freeze_key':'0',
    'kernels_per_layer':1,
    'n_classes':6, #à adapter en fonction d'une éventuelle pinball loss
