...
train_config = {
    ...
    'checkpoints_path': '/home/luther/Documents/result/avw_psc_chl_monthly/ablation/', 
    'verbose': 0.,
    'checkpoint':None, #save the weights every x epochs
    'name':'SmaAt_chlm_avw_variables_all_loss_calib',
    ...
    'comment':'weights loss testing for article with psc'
}
