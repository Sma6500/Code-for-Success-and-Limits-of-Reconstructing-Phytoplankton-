...
train_config = {
    ...
    'checkpoints_path': '/home/luther/Documents/result/avw_psc_chl_monthly/split/', 
    'verbose': 0.,
    'checkpoint':None, #save the weights every x epochs
    'name':'SmaAt_chlm_avw_variables_all_diff_split',
    ...
    'comment':'split testing for article with psc A will be 2008-2018-valid 2018-2022'
}
