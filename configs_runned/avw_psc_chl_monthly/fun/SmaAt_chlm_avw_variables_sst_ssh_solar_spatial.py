...
from utils.transform import CustomMask
...
train_config = {
    ...
    'name':'SmaAt_chlm_avw_variables_sst_ssh_solar_spatial',
    ...
    'comment':'variables testing for article avec une bande de latitude seulement'
}
