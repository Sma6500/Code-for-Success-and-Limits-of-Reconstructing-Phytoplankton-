...
dataloader_config={'dataset_path_inputs':path+"physics/fun/cosin.npy",
                   'dataset_path_inputs_test':path+"physics/fun/cosin_tot.npy",
...
train_config = {
    ...
    'checkpoints_path': '/home/luther/Documents/result/avw_psc_chl_monthly/fun/', 
    'verbose': 0.,
    'checkpoint':None, #save the weights every x epochs
    'name':'SmaAt_chlm_avw_variables_cosin',
    ...
    'comment':'cosin testing for article'
}
