...
dataloader_config={'dataset_path_inputs':path+"physics/processed_physics_1998_2021_8d_lat50_100km.npy",
                   ...
                   'dataset_path_chl':path+"chl/chl_avw_lat50_100km_8d_1998_2021.npy",
                   'transform':None,
                   'batch_size': 32,
                   'norm_chl':True,
                   'norm_mode':'standard',
...
train_config = {
    ...
    'comment':'SMaat avec chl anomalies en sortie et physics anomalies, avec le trend calculé avant transfo'
}
...
model_config = {
    ...
    'freeze_key':'0',
    'kernels_per_layer':2,
    'chl':2, # 0 pour prédire CHL et PSC (maintient la compatibilité avec les configs passées).
