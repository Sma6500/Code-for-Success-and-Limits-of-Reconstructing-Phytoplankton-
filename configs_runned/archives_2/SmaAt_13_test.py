...
dataloader_config={'dataset_path_inputs':path+"physics/processed_physics_1998_2021_8d_lat50_100km.npy",
                   'dataset_path_psc':path+"PSC/PSC_Roy_openocean_8d_1998_2021_lat50_100km.npy",
                   'dataset_path_chl':path+"chl/chl_openocean_avw_lat50_100km_8d_1998_2021.npy",
                   'transform':None,
                   'batch_size': 32,
                   'norm_chl':True,
                   'norm_mode':'standard',
                   'log_chl':True,
                   'anomalies':False, #0 or False or None for classic behavior, 1 for chl anomalies, 2 for physics anomalies 
                   'completion':'zeros',
...
criterion_config = {
    ...
    'Under_chl':0.,
    'KL_div':0.,
    'quantile_loss':0,#((0.5,0.5),(0.05,0.05),(0.25,0.20),(0.75,0.20),(0.95,0.05)),
    'HingeLoss':0.,
    'details':True
}
