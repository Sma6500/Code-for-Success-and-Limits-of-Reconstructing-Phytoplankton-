...
dataloader_config={'dataset_path_inputs':path+"physics/physics_completion/processed_1998_2023_reanalysis_100km_daily_seaice_16.npy",
                   'dataset_path_psc':path+"completion/avw_cmems/psc_pcorrected_avw_cmems_1d_glob_100km_1998_2023.npy",
                   'dataset_path_chl':path+"completion/avw_cmems/chl_avw_cmems_1d_glob_100km_1998_2023.npy",
                   'transform':None,
                   'batch_size': 16,
                   'norm_chl':True,
                   'norm_mode':'standard',
...
train_config = {
    ...
    'comment':'SMaat pour compléter les données avw cmems avec psc et version daily'
}
