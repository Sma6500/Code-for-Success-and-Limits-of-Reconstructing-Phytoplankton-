...
dataloader_config={'dataset_path_inputs':path+"physics/physics_completion/processed_1998_2023_reanalysis_100km_8d_seaice_32.npy",
                   'dataset_path_psc':path+"completion/occci_cmems/psc_p_occci_glob_100_1998_2023_8d_TGDM.npy",
                   'dataset_path_chl':path+"completion/occci_cmems/chl_occci_glob_100_1998_2023_8d_TGDM.npy",
                   'transform':None,
                   'batch_size': 16,
                   'norm_chl':True,
                   'norm_mode':'standard',
