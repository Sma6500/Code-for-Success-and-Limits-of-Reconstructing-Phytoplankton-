...
dataloader_config={'dataset_path_inputs':path+"physics/physics_completion/processed_1998_2023_reanalysis_100km_8d_seaice_32.npy",
                   'dataset_path_psc':path+"completion/avw_cmems/psc_pcorrected_avw_cmems_8d_glob_100km_1998_2023.npy",
...
train_config = {
    ...
    'name':'SmaAt_avwcmems_corrected_completion',
    ...
    'comment':'SMaat pour compléter les données avwcmems avec psc recalé pour être des %'
}
