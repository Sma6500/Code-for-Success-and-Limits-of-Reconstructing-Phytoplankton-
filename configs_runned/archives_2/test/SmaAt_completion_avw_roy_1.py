...
dataloader_config={'dataset_path_inputs':path+"physics/physics_completion/processed_1998_2023_reanalysis_100km_daily_seaice.nc",
                   ...
                   'dataset_path_chl_psc':path+"completion/avw_roy/chl_psc_avw_roy_1d_glob_100km_1998_2023.nc",
...
train_config = {
    ...
    'name':'SmaAt_completion_avw_roy_1',
    ...
    'comment':'SMaat completion MSE classique deuxième essai '
}
