...
dataloader_config={'dataset_path_inputs':path+"physics/processed_physics_1998_2023_8d_lat50_100.npy",
                   'dataset_path_inputs_test':path+"physics/processed_physics_1993_2023_8d_lat50_100.npy",
                   'dataset_path_psc':path+"PSC/1998_2023_psc4_8d_100km_lat50.npy",
                   'dataset_path_chl':path+"chl/chl_occi_lat50_100km_8d_1998_2023.npy",
...
train_config = {
    ...
    'checkpoints_path': '/home/luther/Documents/result/occci/', 
    'verbose': 0.,
    'checkpoint':None, #save the weights every x epochs
    'name':'SmaAt_occci_variables_anom_sst',
...
model_config = {
    ...
    'chl':4, # 0 pour prédire CHL et PSC (maintient la compatibilité avec les configs passées).
                 ...
                 # autres pour sortir direct l'output de la dernière 1x1 convolution (nb de channel = nclasses)
    'nb_layers':32,
    'time2vec':False,
}
