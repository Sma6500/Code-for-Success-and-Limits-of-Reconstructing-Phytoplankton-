...
dataloader_config={'dataset_path_inputs':path+"physics/processed_physics_1998_2020_8d_100_lat50.npy",
                   ...
                   'dataset_path_chl':path+"chl/chl_occi_1998_2020_100k_8d_lat50.npy",
                   'transform':None,
                   'batch_size': 32,
                   'norm_chl':True,
                   'norm_mode':'standard',
...
train_config = {
    ...
    'checkpoints_path': '/home/luther/Documents/result/chl_output/', 
    'verbose': 0.,
    ...
    'comment':'sortie chl occi only, quantile à 0.95, similaire à Smaat_11/10'
}
