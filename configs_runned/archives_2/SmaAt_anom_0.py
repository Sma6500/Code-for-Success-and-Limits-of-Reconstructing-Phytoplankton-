...
dataloader_config={'dataset_path_inputs':path+"physics/processed_physics_1998_2023_8d_lat50_100.npy",
                   ...
                   'norm_mode':'standard',
                   'log_chl':True,
                   'anomalies':1, #0 or False or None for classic behavior, 1 for chl anomalies, 2 for physics anomalies 
                   'completion':'zeros',
...
train_config = {
    ...
    'checkpoints_path': '/home/luther/Documents/result/anomalies/', 
    'verbose': 0.,
    'checkpoint':None, #save the weights every x epochs
    'name':'SmaAt_anom_0',
    'patience_early_stopping':10, #needs to be >>> patience of lr scheduler
    ...
    'comment':'SMaat anomalies MSE classique open ocean (2pix)'
}
...
model_config = {
    ...
    'freeze_key':'0',
    'kernels_per_layer':2,
    'n_classes':5, #à adapter en fonction d'une éventuelle pinball loss
