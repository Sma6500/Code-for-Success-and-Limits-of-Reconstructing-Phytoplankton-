...
dataloader_config={'dataset_path_inputs':path+"physics/processed_physics_openocean_1998_2021_8d_lat50_100km.npy",
...
train_config = {
    ...
    'comment':'SMaat sans bathy ni soleil et seulement open ocean'
}
