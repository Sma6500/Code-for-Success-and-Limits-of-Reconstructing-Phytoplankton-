...
dataloader_config={'dataset_path_inputs':path+"physics/physics_completion/processed_1998_2023_reanalysis_100km_monthly_lat50_seaice_ssr.nc",
                   ...
                   'phy_anomalies':[7], #[0,1,2,3...] list of which physical fields anomalies should be added
                   'chl_anomalies':False, 
                   } 
                   #weekly
...
train_config = {
    ...
    'checkpoints_path': '/home/luther/Documents/result/avw_psc_chl_monthly/variables/', 
    'verbose': 0.,
    'checkpoint':None, #save the weights every x epochs
    'name':'SmaAt_chlm_avw_variables_ssrA_solar',
