...
class Dataset_psc_chl(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.test :
            ...
            print("\n1")
            print(self.physics_dataset.shape)
        ...
        print(self.scaler_phy.mean.shape)
        # on normalise
        ...
        print(f"phy :{physics.shape},\nchl:{chl_masked.shape},\npsc:{psc_masked.shape}")
...
if __name__=='__main__': 
    ...
    dataloader_config={'dataset_path_inputs':path+"physics/physics_completion/1998_2023_reanalysis_100km_daily_seaice.nc",
