...
def get_dataloaders(dataloader_config):
    ...
    #physics=np.concatenate((np.expand_dims(physics[:,1]-sst_mean,axis=1),physics[:,:2],physics[:,3:4]),axis=1)
    ...
    if 'anomalies' in dataloader_config.keys() and dataloader_config['anomalies']:
...
if __name__=='__main__': 
    ...
    input_dim = 1  # Change this to your actual input size
