...
class Dataset_psc_chl(Dataset):
    ...
    def __init__(self, mask, indexs, scaler_chl, dataloader_config, transform=None, completion='inf value', test=False):
